...
export const WorkoutStateSchema = z.object({
  ...
  completedSets: z.record(z.string(), z.number().int().min(0)),
  actualReps: z.record(z.string(), z.array(z.number().int().min(0))),
  actualWeights: z.record(z.string(), z.array(z.number().min(0))),
