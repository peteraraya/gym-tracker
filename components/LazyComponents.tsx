...
export const LazyBodyMap = lazy(() =>
  import("./BodyMap").then((mod) => ({ default: mod.BodyMap })),
);
export const LazyActivityHeatmap = lazy(() =>
  import("./ActivityHeatmap").then((mod) => ({ default: mod.ActivityHeatmap })),
);
// ProgressCharts tiene default export → import directo
export const LazyProgressCharts = lazy(() => import("./ProgressCharts"));
