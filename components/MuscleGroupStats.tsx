...
export const MuscleGroupStats: React.FC<MuscleGroupStatsProps> = ({
  sessions,
}) => {
              ...
              <div key={stat.muscleGroup} className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-2">
                    <MuscleGroupIcon muscleGroup={stat.muscleGroup} size={24} />
                  ...
                  <div className="flex items-center gap-4 text-xs text-gray-600 dark:text-gray-400">
                    <span>
                      {stat.exercises.size} {t("exercises")}
                    </span>
                    <span>
                      {stat.sets} {t("sets")}
                    </span>
                ...
                <div className="relative h-8 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${percentage}%`,
                      backgroundColor:
                        APP_CONFIG.muscleGroupColors[stat.muscleGroup],
                    }}
                  >
                    {percentage > 20 && (
