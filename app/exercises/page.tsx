      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
        <div className="container mx-auto px-4 py-6 md:py-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-6 md:mb-8">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <Button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl shadow-sm hover:shadow-md transition-all"
                >
                  ⚙️ Equipamiento
                </Button>
              </div>
            ...
            {/* Filtro de equipamiento mejorado */}
            {selectedEquipment.size > 0 && (
              <div className="mt-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4 shadow-sm">
          ...
          {!selectedMuscle ? (
            <>
              ...
              {/* Grid de grupos musculares mejorado */}
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">{MUSCLE_GROUPS
                  .filter(muscle => 
                  ...
                  return (
                    <button
                      ...
                      className="group relative flex flex-col items-center justify-center p-4 md:p-6 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-2xl hover:border-blue-500 dark:hover:border-blue-400 hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden"
                    ...
                    >
                      ...
                      <span className="relative z-10 text-sm md:text-base font-bold text-gray-900 dark:text-gray-100 text-center mb-2">
                        {muscle.name}
                      </span>
                      
                      <div className="relative z-10 flex flex-col items-center gap-1.5 mt-1">
                        {selectedEquipment.size > 0 ? (
                          <span className="text-xs md:text-sm text-gray-600 dark:text-gray-400 font-medium px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded-full">
                        ...
                        {warmupCount > 0 && (
                          <span className="text-xs px-2.5 py-1 rounded-full bg-gradient-to-r from-amber-100 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30 text-amber-700 dark:text-amber-400 font-medium shadow-sm">
              ...
              {searchTerm && MUSCLE_GROUPS.filter(muscle => 
                ...
                <div className="text-center py-16 px-4">
                  ...
                  <button
                    onClick={() => setSearchTerm('')}
                    className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium rounded-xl transition-all shadow-md hover:shadow-lg"
                  >
                    Limpiar búsqueda
                  </button>
                </div>
            ...
            <>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    ...
                    {selectedEquipment.size > 0 && availableCount < totalCount && (
                      <span className="ml-2 text-blue-600 dark:text-blue-400 font-medium">(filtrado por equipamiento)</span>
                    )}
                  </p>
                </div>
                <button
              ...
              <div className="flex gap-3 mb-6">
                <button
                  ...
                  className={`flex-1 py-3 px-4 text-sm font-semibold rounded-xl border-2 transition-all shadow-sm ${
                    exerciseTab === 'training'
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {[
                    ...
                    <button
                      ...
                      className={`px-3 py-2 text-sm font-medium rounded-full border-2 transition-all shadow-sm ${
              ...
              {/* Mensaje "Pronto más" mejorado */}
              {totalCount > 0 && totalCount < 11 && (
                <div className="mb-6 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-700 rounded-2xl text-center shadow-sm">
                  <div className="text-4xl mb-3">🚀</div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Pronto habrá más ejercicios</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Estamos trabajando en ampliar esta sección. Mientras tanto puedes explorar otros grupos musculares.
                  </p>
                </div>
              )}
              ...
              <div className="space-y-4">
                {paginatedExercises.map((exercise) => {
                  ...
                  return (
                  <Card key={exercise.id} className={`hover:shadow-xl transition-all duration-300 overflow-hidden ${exerciseTab === 'warmup' ? 'border-amber-200 dark:border-amber-800' : 'border-gray-200 dark:border-gray-700'}`}>
                    <div className="flex flex-col md:flex-row gap-4">
                      {/* Image/Icon Section mejorada */}
                      <div className="md:w-48 flex-shrink-0">
                        {exercise.image ? (
                          <div className="w-full h-48 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 overflow-hidden rounded-t-lg md:rounded-l-lg md:rounded-tr-none">
                      ...
                      <div className="flex-1 p-4 md:p-5">
                        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3 mb-3">
                          <div className="flex-1">
                            <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">{exercise.name}</h3>
                            <div className="flex flex-wrap gap-2">
                              <span className="px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900 dark:to-indigo-900 text-blue-800 dark:text-blue-200 shadow-sm">
                                {exercise.equipment}
                              </span>
                              {warmup && categoryInfo && (
                          ...
                          <button 
                            ...
                            className={`px-5 py-2.5 ${exerciseTab === 'warmup' ? 'bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600' : 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700'} text-white font-semibold rounded-xl transition-all shadow-md hover:shadow-lg whitespace-nowrap`}
                          >
                            Ver técnica
                          </button>
                        </div>
                        ...
                        {exercise.description && (
                          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4 leading-relaxed">{exercise.description}</p>
                        )}

                        <div className="flex flex-wrap gap-3">
                          {exercise.recommendedSets && (
                            <div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg shadow-sm">
                          ...
                          {exercise.recommendedReps && (
                            <div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg shadow-sm">
                          ...
                          {exercise.restTime && (
                            <div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-lg shadow-sm">
                              <span className="text-gray-700 dark:text-gray-400 text-sm font-medium">⏱️ {exercise.restTime}</span>
                            </div>
                          )}
                          {warmup && warmup.duration && (
                            <div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-lg shadow-sm">
                              <span className="text-amber-700 dark:text-amber-400 text-sm font-medium">⏱️ {warmup.duration}</span>
                            </div>
                          )}
                        </div>
                        ...
                        {warmup && warmup.targetMuscles && warmup.targetMuscles.length > 0 && (
                          <div className="flex flex-wrap gap-2 mt-3">
                            {warmup.targetMuscles.map(m => (
                              <span key={m} className="text-xs px-2.5 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 rounded-full font-medium">
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-4 py-2 rounded-xl border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-blue-400 transition-all font-medium shadow-sm"
                    >
                      ← Anterior
                    </button>
              ...
              {currentExercises.length === 0 && (
                <div className="text-center py-16 px-4">
                  <div className="text-7xl mb-6 animate-bounce">{exerciseTab === 'warmup' ? '🔥' : '🔍'}</div>
                  <h3 className="text-2xl font-semibold text-gray-700 dark:text-gray-300 mb-3">
