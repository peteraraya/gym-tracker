...
import { Plus, ClipboardList, Zap, Play, Pencil, Trash2, Copy, Flame, Dumbbell } from '@/components/icons/lucide';
    ...
    <ProtectedRoute>
      <PageLayout>
        ...
        <PageContent>
          ...
          {/* Content */}
          {loading ? (
            <LoadingSpinner size="lg" message={t('loading')} className="py-20" />
          ) : routines.length === 0 ? (
            <EmptyStateCard
