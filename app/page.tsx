                ...
                {routines.length > 0 && (
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <select 
                      ...
                      // onChange={(e) => {
                      //   if (e.target.value) {
                      //     window.location.href = `/workout/${e.target.value}`
                      //   }
                      // }}
                      defaultValue=""
                    >
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        ...
                        if (select?.value) {
                          window.location.href = `/workout/${select.value}`
                        } else if (routines[0]) {
                          window.location.href = `/workout/${routines[0].id}`
                        }
                      }}
                    >
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-100 dark:border-gray-700">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">{t('routinesCard')}</p>
                  </div>
                </div>
                <Link href="/routines">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-100 dark:border-gray-700">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">{t('sessionsCard')}</p>
                  </div>
                </div>
                <Link href="/sessions">
                  <Button variant="ghost" size="sm" className="w-full">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-100 dark:border-gray-700">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">{t('exercisesCard')}</p>
                  </div>
                </div>
                <Link href="/exercises">
                  <Button variant="ghost" size="sm" className="w-full">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                {routines.length === 0 ? (
                  ...
                  <Card className="hover:shadow-lg transition-shadow">
                    ...
                    <CardContent>
                      <p className="mb-4 text-sm sm:text-base text-gray-600 dark:text-gray-400">
                        {t('haveRoutines.subtitle') || `${routines.length} rutinas creadas`}
                      </p>
                      <Link href="/routines">
                        <Button variant="primary" className="w-full">
              ...
              <div className="space-y-6">
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <p className="mb-4 text-sm sm:text-base text-gray-600 dark:text-gray-400">
                      {t('exerciseGuideDesc') || 'Explora ejercicios y aprende técnica'}
                    </p>
                    <Link href="/exercises">
                      <Button variant="secondary" className="w-full">
